...
## Environments
- Preview: https://main--site-20--s24onboading.hlx.page/
- Live: https://main--site-20--s24onboading.hlx.live/
- Custom Domain: https://site-20.playground.name (Available during the lab)
...
WKND_URL=https://main--site-20--s24onboading.hlx.live ITERATIONS=1000 npm run generate-traffic
```
